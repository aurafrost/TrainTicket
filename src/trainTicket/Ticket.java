...
public class Ticket{
	...
	public int getCounter() {
		/*
		File ticketCount=new File("counter.txt");
		if(ticketCount.exists()) {
			try {
				FileInputStream fis=new FileInputStream(ticketCount);
				...
				while(reader.ready()) {
					...
					setCounter(count);
					FileOutputStream fos=new FileOutputStream(ticketCount);
					BufferedOutputStream bos=new BufferedOutputStream(fos);
					count++;
					bos.write(count);
					bos.flush();
